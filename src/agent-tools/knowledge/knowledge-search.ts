...
export const knowledgeSearchTool: ToolDefinition = {
  ...
  description: "Search Farai's local security corpus for techniques, payloads, vulnerabilities, and taxonomy material from sources such as HackTricks, payload collections, CVE, CWE, CAPEC, and ATT&CK. Returns ranked records with provenance; use knowledge_read for full text and web_search for current public information.",
  inputSchema: {
    type: "object",
    required: ["query"],
    properties: {
