  ...
  const stable = [
    ...
    },
    {
      ...
      body: [
        ...
        "browser_navigate already returns the loaded page snapshot. Call browser_snapshot only if it is missing, stale, or state changed. Never repeat the same URL, request index, response part, or multi-tool observation cycle; analyze, verify, save evidence, or conclude.",
